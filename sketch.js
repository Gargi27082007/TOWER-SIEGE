...
function setup() {
  ...
  block17 = new Block(700,45,30,40);
...
function draw() {
  ...
  imageMode(CENTER);
 image( polygon_img, polygonObj.position.x, polygonObj.position.y, 20, 20);
  slingShot.display();
